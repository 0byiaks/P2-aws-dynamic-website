...
export DOMAIN_NAME='titotest.co.uk' # the domain name 
export S3_BUCKET_NAME='dev-app-nest-webfiles' # the name of the s3 bucket containing your application code
...
export RDS_ENDPOINT='dev-db.cknuiwg20qbv.us-east-1.rds.amazonaws.com' # your rds endpoint.amazonaws.com
export RDS_DB_NAME='applicationdb' # your rds database name
export RDS_DB_USERNAME='admin' # your rds database username
export SECRET_NAME='rds!db-3797764c-868e-4648-8b01-44399a8ba646' # the name of the secret in AWS Secrets Manager
...
echo "SERVICE_PROVIDER_FILE_NAME: $SERVICE_PROVIDER_FILE_NAME"
echo "APPLICATION_CODE_FILE_NAME: $APPLICATION_CODE_FILE_NAME"
