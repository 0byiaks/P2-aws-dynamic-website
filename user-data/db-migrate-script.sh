...
export S3_URI='s3://dev-app-nest-webfiles/V1__nest.sql'
export RDS_ENDPOINT='dev-db.cknuiwg20qbv.us-east-1.rds.amazonaws.com'
export RDS_DB_NAME='applicationdb'
export RDS_DB_USERNAME='admin'
export FLYWAY_VERSION='11.15.0'
export SECRET_NAME='rds!db-3797764c-868e-4648-8b01-44399a8ba646'
